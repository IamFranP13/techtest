...
public class PriceControllerTest {
    ...
    public void getApplicablePrice_ReturnsPrice() throws Exception {
        ...
        ApplicablePrice applicablePrice1 = new ApplicablePrice(1, 1, 35455, LocalDateTime.parse("2020-06-14T00:00:00"), LocalDateTime.parse("2020-12-31T23:59:59"), 1, new BigDecimal("35.50"), 0, "EUR");


        ApplicablePriceResponseDto responseDto1 = new ApplicablePriceResponseDto(35455, 1, LocalDateTime.parse("2020-06-14T00:00:00"), LocalDateTime.parse("2020-12-31T23:59:59"), 1, 1, new BigDecimal("35.50"), "EUR");

        ApplicablePrice applicablePrice2 = new ApplicablePrice(2, 1, 35455, LocalDateTime.parse("2020-06-14T15:00:00"), LocalDateTime.parse("2020-06-14T18:30:00"), 1,  new BigDecimal("25.45"), 1, "EUR");

        ApplicablePriceResponseDto responseDto2 = new ApplicablePriceResponseDto(35455, 1, LocalDateTime.parse("2020-06-14T15:00:00"), LocalDateTime.parse("2020-06-14T18:30:00"), 2, 2, new BigDecimal("25.45"), "EUR");
